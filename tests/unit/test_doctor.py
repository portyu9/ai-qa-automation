...
def test_doctor_reports_secret_presence_without_revealing_secret(monkeypatch, tmp_path: Path) -> None:
...
def test_doctor_distinguishes_disabled_and_incomplete_github_mcp(monkeypatch, tmp_path: Path) -> None:
