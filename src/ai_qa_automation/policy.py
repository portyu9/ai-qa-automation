...
class PolicyEngine:
    ...
    def authorize_tool(self, tool_name: str, tool_input: dict[str, Any]) -> PolicyDecision:
        ...
        if tool_name.startswith("mcp__"):
            ...
            if path_value:
                ...
                path_decision = (
                    self.authorize_test_proposal_target(path)
    ...
    def authorize_test_proposal_target(self, path: Path) -> PolicyDecision:
        """Constrain a proposal subject without granting repository write authority."""
